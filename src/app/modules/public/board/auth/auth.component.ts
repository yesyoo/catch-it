...
export class AuthComponent implements OnInit {
  ...
  @ViewChild('btnAuth') btnAuth: ElementRef
  @ViewChild('btnReg') btnReg: ElementRef
  ...
  changeFormType(type: 'authorization' | 'registration') {
    if(this.type !== type) {
      ...
      if(type === 'authorization') {
        this.btnAuth?.nativeElement.classList.add('title-active')
        this.btnReg?.nativeElement.classList.remove('title-active')
      } else {
        this.btnAuth?.nativeElement.classList.remove('title-active')
        this.btnReg?.nativeElement.classList.add('title-active')
