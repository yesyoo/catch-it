...
@Component({
  selector: 'app-board-items-owner',
  templateUrl: './board-items-owner.component.html',
  styleUrls: ['./board-items-owner.component.scss']
})
export class BoardItemsOwnerComponent implements OnInit {
